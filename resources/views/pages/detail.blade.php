        ...
        <section class="store-gallery" id="gallery">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="row">
                            <div class="cold-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo, index) in photos"
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="/images/icon-review-1.jpg" class="mr-3 rounded-circle" alt="" />
                                ...
                                <li class="media">
                                    <img src="/images/icon-review-2.jpg" class="mr-3 rounded-circle" alt="" />
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="/images/icon-review-3.jpg" class="mr-3 rounded-circle" alt="" />
                                    <div class="media-body">
