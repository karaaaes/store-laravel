                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="" v-model="store_name"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input type="number" name="price" id="" v-model="store_name"
                ...
                <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="gallery-container">
                                                ...
                                                <a href="{{ route('dashboard-product-gallery-delete', $gallery->id) }}"
                                                    ...
                                                    <img src="/images/icon-deletes.svg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <div class="col-12">
                        <form action="{{ route('dashboard-product-gallery-upload') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="file" name="photos" id="file" class="" style="display: none;" onchange="form.submit()">
                            <button type="button" class="btn btn-secondary btn-block mt-3" onclick="thisFileUpload()">Add
                                Photo</button>
                        </form>
                    </div>
                </div>
